  ...
  return (
    <Container>
      ...
      >
        ...
        <MenuLink to="https://github.com/umesh-webdev25/TodoApp.git">
        ...
        <MenuLink to="https://github.com/umesh-webdev25/TodoApp.git/issues/new">
          <StyledMenuItem>
        ...
        <ProfileOptionsBottom>
          ...
          <CreditsContainer translate="no">
            ...
            <a
              ...
              href="https://github.com/umesh-webdev25/TodoApp.git"
            >
              maciekt07
            </a>
          </CreditsContainer>
